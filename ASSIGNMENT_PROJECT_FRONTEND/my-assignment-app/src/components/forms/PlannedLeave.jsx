...
export default function PlannedForm({handleSubmit, logger}) {
    const [thisForm, setForm] = useState({ request_type:"PLANNED LEAVE"});
  ...
  return (
    <Flex alignItems='center' justifyContent='start' flexDir='column' flexWrap='wrap' w='full' gap='20px'>
        <Heading size='md' mt='20px'>Planned Leave</Heading>
        <FormControl>
            <FormLabel>Request Type</FormLabel>
            <Select name='request_type' isDisabled value='PLANNED LEAVE' placeholder="PLANNED LEAVE" colorScheme='purple'>
        ...
        <Button onClick={handleClick} colorScheme='orange'>Raise</Button>
    </Flex>
  )
}
